# Champion Log Generation Prompt for Tayrel

You are to generate a complete champion log for Tayrel in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Tayrel. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Tayrel using the template above.
