# Champion Log Generation Prompt for Scyl of the Drakes

You are to generate a complete champion log for Scyl of the Drakes in JSON format, using the following module templates as structure and guidance. Each module (0–13) is included below. For each, fill in the relevant information for Scyl of the Drakes. Output a single JSON object with each module as a key (e.g., "overview", "skills", "synergy", etc.).

---
## Example output structure:
```json
{
  "champion": "Scyl of the Drakes",
  "owned": true,
  "overview": { ... },
  "skills": { ... },
  "team_inputs": { ... },
...
---
Instructions:
- Fill in each section for Scyl of the Drakes using the module templates below.
