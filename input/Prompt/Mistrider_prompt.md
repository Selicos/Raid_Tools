# Champion Log Generation Prompt for Mistrider

You are to generate a complete champion log for Mistrider in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Mistrider. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Mistrider using the template above.
