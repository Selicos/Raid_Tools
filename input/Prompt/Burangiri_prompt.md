# Champion Log Generation Prompt for Burangiri

You are to generate a complete champion log for Burangiri in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Burangiri. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Burangiri using the template above.
