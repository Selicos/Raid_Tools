# Champion Log Generation Prompt for Sun Wukong

You are to generate a complete champion log for Sun Wukong in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Sun Wukong. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Sun Wukong using the template above.
