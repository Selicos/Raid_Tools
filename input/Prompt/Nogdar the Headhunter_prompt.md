# Champion Log Generation Prompt for Nogdar the Headhunter

You are to generate a complete champion log for Nogdar the Headhunter in JSON format, using the following module templates as structure and guidance. Each module (0–13) is included below. For each, fill in the relevant information for Nogdar the Headhunter. Output a single JSON object with each module as a key (e.g., "overview", "skills", "synergy", etc.).

---
## Example output structure:
```json
{
  "champion": "Nogdar the Headhunter",
  "owned": true,
  "overview": { ... },
  "skills": { ... },
  "team_inputs": { ... },
...
---
Instructions:
- Fill in each section for Nogdar the Headhunter using the module templates below.
