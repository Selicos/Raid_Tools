# Champion Log Generation Prompt for Warchief

You are to generate a complete champion log for Warchief in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Warchief. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Warchief using the template above.
