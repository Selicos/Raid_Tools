# Champion Log Generation Prompt for Dark Kael

You are to generate a complete champion log for Dark Kael in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Dark Kael. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Dark Kael using the template above.
