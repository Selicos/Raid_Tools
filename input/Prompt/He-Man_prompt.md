# Champion Log Generation Prompt for He-Man

You are to generate a complete champion log for He-Man in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for He-Man. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for He-Man using the template above.
