# Champion Log Generation Prompt for Quargan the Crowned

You are to generate a complete champion log for Quargan the Crowned in JSON format, using the following module templates as structure and guidance. Each module (0–13) is included below. For each, fill in the relevant information for Quargan the Crowned. Output a single JSON object with each module as a key (e.g., "overview", "skills", "synergy", etc.).

---
## Example output structure:
```json
{
  "champion": "Quargan the Crowned",
  "owned": true,
  "overview": { ... },
  "skills": { ... },
  "team_inputs": { ... },
...
---
Instructions:
- Fill in each section for Quargan the Crowned using the module templates below.
