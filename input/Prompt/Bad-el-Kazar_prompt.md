# Champion Log Generation Prompt for Bad-el-Kazar

You are to generate a complete champion log for Bad-el-Kazar in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Bad-el-Kazar. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Bad-el-Kazar using the template above.
