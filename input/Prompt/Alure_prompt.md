# Champion Log Generation Prompt for Alure

You are to generate a complete champion log for Alure in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Alure. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Alure using the template above.
