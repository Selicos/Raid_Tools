# Champion Log Generation Prompt for Hotatsu

You are to generate a complete champion log for Hotatsu in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Hotatsu. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Hotatsu using the template above.
