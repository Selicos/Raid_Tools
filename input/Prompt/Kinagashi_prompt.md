# Champion Log Generation Prompt for Kinagashi

You are to generate a complete champion log for Kinagashi in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Kinagashi. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Kinagashi using the template above.
