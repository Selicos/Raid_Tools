# Champion Log Generation Prompt for Skeletor

You are to generate a complete champion log for Skeletor in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Skeletor. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Skeletor using the template above.
