...
You are to generate a complete champion log for White Dryad Nia in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for White Dryad Nia. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for White Dryad Nia using the template above.
