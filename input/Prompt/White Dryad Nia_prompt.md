# Champion Log Generation Prompt for White Dryad Nia

You are to generate a complete champion log for White Dryad Nia in JSON format, using the following module templates as structure and guidance. Each module (0–13) is included below. For each, fill in the relevant information for White Dryad Nia. Output a single JSON object with each module as a key (e.g., "overview", "skills", "synergy", etc.).

---
## Example output structure:
```json
{
  "champion": "White Dryad Nia",
  "owned": true,
  "overview": { ... },
  "skills": { ... },
  "team_inputs": { ... },
...
---
Instructions:
- Fill in each section for White Dryad Nia using the module templates below.
