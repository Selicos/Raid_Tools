# Champion Log Generation Prompt for Venomage

You are to generate a complete champion log for Venomage in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Venomage. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Venomage using the template above.
