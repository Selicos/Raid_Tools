# Champion Log Generation Prompt for Seeker

You are to generate a complete champion log for Seeker in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Seeker. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Seeker using the template above.
