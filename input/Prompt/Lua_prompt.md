...
You are to generate a complete champion log for Lua in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Lua. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Lua using the template above.
