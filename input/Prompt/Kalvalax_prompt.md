# Champion Log Generation Prompt for Kalvalax

You are to generate a complete champion log for Kalvalax in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Kalvalax. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Kalvalax using the template above.
