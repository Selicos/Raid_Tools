# Champion Log Generation Prompt for Criodan

You are to generate a complete champion log for Criodan in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Criodan. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Criodan using the template above.
