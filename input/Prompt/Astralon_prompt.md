# Champion Log Generation Prompt for Astralon

You are to generate a complete champion log for Astralon in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Astralon. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Astralon using the template above.
