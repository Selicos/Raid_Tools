# Champion Log Generation Prompt for Tagoar

You are to generate a complete champion log for Tagoar in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Tagoar. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Tagoar using the template above.
