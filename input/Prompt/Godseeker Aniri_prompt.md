# Champion Log Generation Prompt for Godseeker Aniri

You are to generate a complete champion log for Godseeker Aniri in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Godseeker Aniri. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Godseeker Aniri using the template above.
