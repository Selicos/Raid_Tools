# Champion Log Generation Prompt for Mithrala

You are to generate a complete champion log for Mithrala in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Mithrala. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Mithrala using the template above.
