# Champion Log Generation Prompt for Queen Eva

You are to generate a complete champion log for Queen Eva in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Queen Eva. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Queen Eva using the template above.
