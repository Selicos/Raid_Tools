# Champion Log Generation Prompt for Lady Annabelle

You are to generate a complete champion log for Lady Annabelle in JSON format, using the following module templates as structure and guidance. Each module (0–13) is included below. For each, fill in the relevant information for Lady Annabelle. Output a single JSON object with each module as a key (e.g., "overview", "skills", "synergy", etc.).

---
## Example output structure:
```json
{
  "champion": "Lady Annabelle",
  "owned": true,
  "overview": { ... },
  "skills": { ... },
  "team_inputs": { ... },
...
---
Instructions:
- Fill in each section for Lady Annabelle using the module templates below.
