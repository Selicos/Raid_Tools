# Champion Log Generation Prompt for Deacon Armstrong

You are to generate a complete champion log for Deacon Armstrong in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Deacon Armstrong. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Deacon Armstrong using the template above.
