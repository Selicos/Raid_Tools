...
You are to generate a complete champion log for Lord Shazar in JSON format, using the following module templates as structure and guidance. Each module (0–13) is included below. For each, fill in the relevant information for Lord Shazar. Output a single JSON object with each module as a key (e.g., "overview", "skills", "synergy", etc.).

---
## Example output structure:
```json
{
  "champion": "Lord Shazar",
  "owned": true,
  "overview": { ... },
  "skills": { ... },
  "team_inputs": { ... },
...
---
Instructions:
- Fill in each section for Lord Shazar using the module templates below.
