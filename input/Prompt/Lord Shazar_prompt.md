# Champion Log Generation Prompt for Lord Shazar

You are to generate a complete champion log for Lord Shazar in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Lord Shazar. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Lord Shazar using the template above.
