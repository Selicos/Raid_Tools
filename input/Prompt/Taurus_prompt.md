# Champion Log Generation Prompt for Taurus

You are to generate a complete champion log for Taurus in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Taurus. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Taurus using the template above.
