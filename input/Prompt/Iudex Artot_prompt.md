# Champion Log Generation Prompt for Iudex Artot

You are to generate a complete champion log for Iudex Artot in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Iudex Artot. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Iudex Artot using the template above.
