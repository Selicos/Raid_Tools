# Champion Log Generation Prompt for Elenaril

You are to generate a complete champion log for Elenaril in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Elenaril. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Elenaril using the template above.
