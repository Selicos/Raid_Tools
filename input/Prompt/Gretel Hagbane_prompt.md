# Champion Log Generation Prompt for Gretel Hagbane

You are to generate a complete champion log for Gretel Hagbane in JSON format, using the following module templates as structure and guidance. Each module (0–13) is included below. For each, fill in the relevant information for Gretel Hagbane. Output a single JSON object with each module as a key (e.g., "overview", "skills", "synergy", etc.).

---
## Example output structure:
```json
{
  "champion": "Gretel Hagbane",
  "owned": true,
  "overview": { ... },
  "skills": { ... },
  "team_inputs": { ... },
...
---
Instructions:
- Fill in each section for Gretel Hagbane using the module templates below.
