# Champion Log Generation Prompt for Mausoleum Mage

You are to generate a complete champion log for Mausoleum Mage in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Mausoleum Mage. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Mausoleum Mage using the template above.
