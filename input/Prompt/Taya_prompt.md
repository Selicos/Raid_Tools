# Champion Log Generation Prompt for Taya

You are to generate a complete champion log for Taya in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Taya. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Taya using the template above.
