# Champion Log Generation Prompt for Apothecary

You are to generate a complete champion log for Apothecary in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Apothecary. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Apothecary using the template above.
