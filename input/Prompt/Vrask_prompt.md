# Champion Log Generation Prompt for Vrask

You are to generate a complete champion log for Vrask in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Vrask. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Vrask using the template above.
