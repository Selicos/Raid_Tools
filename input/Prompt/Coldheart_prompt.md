# Champion Log Generation Prompt for Coldheart

You are to generate a complete champion log for Coldheart in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Coldheart. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Coldheart using the template above.
