ting prompt # Champion Log Generation Prompt for Caolite the Asharrow

You are to generate a complete champion log for Caolite the Asharrow in JSON format, using the following module templates as structure and guidance. Each module (0–13) is included below. For each, fill in the relevant information for Caolite the Asharrow. Output a single JSON object with each module as a key (e.g., "overview", "skills", "synergy", etc.).

---
## Example output structure:
```json
{
  "champion": "Caolite the Asharrow",
  "owned": true,
  "overview": { ... },
  "skills": { ... },
  "team_inputs": { ... },
...
---
Instructions:
- Fill in each section for Caolite the Asharrow using the module templates below.
