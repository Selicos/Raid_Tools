# Champion Log Generation Prompt for Caolite the Asharrow

You are to generate a complete champion log for Caolite the Asharrow in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Caolite the Asharrow. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Caolite the Asharrow using the template above.
