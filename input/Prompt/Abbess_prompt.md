# Champion Log Generation Prompt for Abbess

You are to generate a complete champion log for Abbess in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Abbess. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Abbess using the template above.
