# Champion Log Generation Prompt for Cleopterix

You are to generate a complete champion log for Cleopterix in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Cleopterix. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Cleopterix using the template above.
