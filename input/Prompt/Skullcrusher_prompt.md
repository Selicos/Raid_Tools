# Champion Log Generation Prompt for Skullcrusher

You are to generate a complete champion log for Skullcrusher in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Skullcrusher. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Skullcrusher using the template above.
