# Champion Log Generation Prompt for Vergumkaar

You are to generate a complete champion log for Vergumkaar in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Vergumkaar. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Vergumkaar using the template above.
