# Champion Log Generation Prompt for Leminisi the Gold-Wing

You are to generate a complete champion log for Leminisi the Gold-Wing in JSON format, using the following module templates as structure and guidance. Each module (0–13) is included below. For each, fill in the relevant information for Leminisi the Gold-Wing. Output a single JSON object with each module as a key (e.g., "overview", "skills", "synergy", etc.).

---
## Example output structure:
```json
{
  "champion": "Leminisi the Gold-Wing",
  "owned": true,
  "overview": { ... },
  "skills": { ... },
  "team_inputs": { ... },
...
---
Instructions:
- Fill in each section for Leminisi the Gold-Wing using the module templates below.
