# Champion Log Generation Prompt for Dhukk the Pierced

You are to generate a complete champion log for Dhukk the Pierced in JSON format, using the following module templates as structure and guidance. Each module (0–13) is included below. For each, fill in the relevant information for Dhukk the Pierced. Output a single JSON object with each module as a key (e.g., "overview", "skills", "synergy", etc.).

---
## Example output structure:
```json
{
  "champion": "Dhukk the Pierced",
  "owned": true,
  "overview": { ... },
  "skills": { ... },
  "team_inputs": { ... },
...
---
Instructions:
- Fill in each section for Dhukk the Pierced using the module templates below.
