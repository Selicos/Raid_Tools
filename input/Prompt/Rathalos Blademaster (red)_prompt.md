# Champion Log Generation Prompt for Rathalos Blademaster (red)

You are to generate a complete champion log for Rathalos Blademaster (red) in JSON format, using the following module templates as structure and guidance. Each module (0–13) is included below. For each, fill in the relevant information for Rathalos Blademaster (red). Output a single JSON object with each module as a key (e.g., "overview", "skills", "synergy", etc.).

---
## Example output structure:
```json
{
  "champion": "Rathalos Blademaster (red)",
  "owned": true,
  "overview": { ... },
  "skills": { ... },
  "team_inputs": { ... },
...
---
Instructions:
- Fill in each section for Rathalos Blademaster (red) using the module templates below.
