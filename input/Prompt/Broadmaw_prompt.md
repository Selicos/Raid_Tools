# Champion Log Generation Prompt for Broadmaw

You are to generate a complete champion log for Broadmaw in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Broadmaw. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Broadmaw using the template above.
