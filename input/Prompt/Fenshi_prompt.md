# Champion Log Generation Prompt for Fenshi

You are to generate a complete champion log for Fenshi in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Fenshi. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Fenshi using the template above.
