# Champion Log Generation Prompt for Runekeeper Dazdurk

You are to generate a complete champion log for Runekeeper Dazdurk in JSON format, using the following module templates as structure and guidance. Each module (0–13) is included below. For each, fill in the relevant information for Runekeeper Dazdurk. Output a single JSON object with each module as a key (e.g., "overview", "skills", "synergy", etc.).

---
## Example output structure:
```json
{
  "champion": "Runekeeper Dazdurk",
  "owned": true,
  "overview": { ... },
  "skills": { ... },
  "team_inputs": { ... },
...
---
Instructions:
- Fill in each section for Runekeeper Dazdurk using the module templates below.
