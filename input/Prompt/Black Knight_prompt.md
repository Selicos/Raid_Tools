# Champion Log Generation Prompt for Black Knight

You are to generate a complete champion log for Black Knight in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Black Knight. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Black Knight using the template above.
