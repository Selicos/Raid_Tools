# Champion Log Generation Prompt for Vogoth

You are to generate a complete champion log for Vogoth in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Vogoth. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Vogoth using the template above.
