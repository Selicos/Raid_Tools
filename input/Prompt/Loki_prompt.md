# Champion Log Generation Prompt for Loki

You are to generate a complete champion log for Loki in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Loki. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Loki using the template above.
