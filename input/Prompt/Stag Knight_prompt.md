# Champion Log Generation Prompt for Stag Knight

You are to generate a complete champion log for Stag Knight in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Stag Knight. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Stag Knight using the template above.
