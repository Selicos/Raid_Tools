# Champion Log Generation Prompt for Maulie Tankard

You are to generate a complete champion log for Maulie Tankard in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Maulie Tankard. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Maulie Tankard using the template above.
