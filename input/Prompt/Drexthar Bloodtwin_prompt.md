# Champion Log Generation Prompt for Drexthar Bloodtwin

You are to generate a complete champion log for Drexthar Bloodtwin in JSON format, using the following module templates as structure and guidance. Each module (0–13) is included below. For each, fill in the relevant information for Drexthar Bloodtwin. Output a single JSON object with each module as a key (e.g., "overview", "skills", "synergy", etc.).

---
## Example output structure:
```json
{
  "champion": "Drexthar Bloodtwin",
  "owned": true,
  "overview": { ... },
  "skills": { ... },
  "team_inputs": { ... },
...
---
Instructions:
- Fill in each section for Drexthar Bloodtwin using the module templates below.
