# Champion Log Generation Prompt for Skullcrown

You are to generate a complete champion log for Skullcrown in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Skullcrown. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Skullcrown using the template above.
