# Champion Log Generation Prompt for Ninja

You are to generate a complete champion log for Ninja in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Ninja. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Ninja using the template above.
