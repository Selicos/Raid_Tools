# Champion Log Generation Prompt for Rector Drath

You are to generate a complete champion log for Rector Drath in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Rector Drath. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Rector Drath using the template above.
