# Champion Log Generation Prompt for Uggo

You are to generate a complete champion log for Uggo in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Uggo. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Uggo using the template above.
