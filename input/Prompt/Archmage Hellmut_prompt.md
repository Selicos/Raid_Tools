...
You are to generate a complete champion log for Archmage Hellmut in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Archmage Hellmut. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Archmage Hellmut using the template above.
