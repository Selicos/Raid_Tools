# Champion Log Generation Prompt for Kantra the Cyclone

You are to generate a complete champion log for Kantra the Cyclone in JSON format, using the following module templates as structure and guidance. Each module (0–13) is included below. For each, fill in the relevant information for Kantra the Cyclone. Output a single JSON object with each module as a key (e.g., "overview", "skills", "synergy", etc.).

---
## Example output structure:
```json
{
  "champion": "Kantra the Cyclone",
  "owned": true,
  "overview": { ... },
  "skills": { ... },
  "team_inputs": { ... },
...
---
Instructions:
- Fill in each section for Kantra the Cyclone using the module templates below.
