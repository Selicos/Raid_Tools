# Champion Log Generation Prompt for Frozen Banshee

You are to generate a complete champion log for Frozen Banshee in JSON format, using the following module templates as structure and guidance. Each module (0–13) is included below. For each, fill in the relevant information for Frozen Banshee. Output a single JSON object with each module as a key (e.g., "overview", "skills", "synergy", etc.).

---
## Example output structure:
```json
{
  "champion": "Frozen Banshee",
  "owned": true,
  "overview": { ... },
  "skills": { ... },
  "team_inputs": { ... },
...
---
Instructions:
- Fill in each section for Frozen Banshee using the module templates below.
