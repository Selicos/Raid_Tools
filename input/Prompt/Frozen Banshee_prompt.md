...
You are to generate a complete champion log for Frozen Banshee in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Frozen Banshee. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Frozen Banshee using the template above.
