# Champion Log Generation Prompt for Djamarsa

You are to generate a complete champion log for Djamarsa in JSON format, using the following template as structure and guidance. Fill in all modules (0–20) for Djamarsa. Output a single JSON object with each module as a key.
...
---
Instructions:
- Fill in each section for Djamarsa using the template above.
