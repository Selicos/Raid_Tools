...
## 6. Chimera Parallel Guide (Trials 4-7)

### 6.1 Chimera vs Clan Boss: Key Differences

| Mechanic | Clan Boss | Chimera | Impact |
|----------|-----------|---------|--------|
| **Target** | Single boss | **3 heads** (Body + Left + Right) | AOE > single-target |
| **Trials** | None | **7 trials** (4-7 endgame) | Mechanic-specific requirements |
| **Debuff Limit** | 10 debuffs | **15 debuffs** (5 per head) | More debuff slots |
| **Speed Tune** | 3:2 (170 SPD boss) | **Varies** (190+ boss SPD) | May break CB tune |
| **Affinity** | Rotates daily | **All 3 heads different** | Multi-affinity team needed |
| **Damage Cap** | HP Burn 75k, Poison 50k | **Same** | HP Burn still king |
| **Turn Limit** | Turn 50+ (unkillable ignores) | **No limit** | Long fights viable |

---

### 6.2 Trial Requirements (4-7 Focus)

**Achievable Trials:**
| Trial | Requirement | Champions | Team Comp | Damage Projection |
|-------|-------------|-----------|-----------|-------------------|
| **5** | Dec ATK 100% uptime | Rector (A1) + Stag (A2) | Rector/Brogni/Stag/Bad-el/Geo | 30-35M ✅ |
| **7** | Continuous Heal 100% uptime | Bad-el + Jareg + Aniri | Aniri/Brogni/Bad-el/Jareg/Geo | 33-40M ✅ |

**NOT Achievable (Missing Champions):**
- **Trial 4:** Decrease SPD 100% uptime (need Apothecary, High Khatun, Arbiter)
- **Trial 6:** Increase DEF 100% uptime (need Doompriest, Sandlashed Survivor, Demytha)

**Trial Mechanics Punishment:**
- Trial 4 failed: Boss gains Inc SPD (+30% SPD = faster boss turns)
- Trial 5 failed: Boss gains Inc ATK (+50% ATK = team dies faster)
- Trial 6 failed: Boss gains Dec DEF (-60% DEF = team does 40% less damage)
- Trial 7 failed: Boss gains Heal Reduction (-100% healing = no sustain)

**Recommendation:** 
1. ✅ **Focus Trial 5 now** (Rector team ready, no regear needed)
2. ⏸️ **Build Jareg for Trial 7** (2-3 weeks, needs SPD 267+ and books)
3. ❌ **Skip Trial 4 & 6** until pulling required champions

---

### 6.3 Core Team Adaptation (Trial 5 Focus)

**Trial 5 Requirement:** Decrease ATK 100% uptime

**Roster:** Rector Drath / Brogni / Stag Knight / Geomancer / Bad-el-Kazar

| Position | Champion | SPD | Role | Trial 5 Contribution |
|----------|----------|-----|------|---------------------|
| 1 | **Rector Drath** | 277 | Dec ATK (A1) | ✅ **100% uptime** (A1 = every turn) |
| 2 | Underpriest Brogni | 274 | Block Debuffs + Shields | Survivability |
| 3 | Stag Knight | 273 | Dec DEF/ATK | ✅ **Backup Dec ATK** (66.7%) |
| 4 | Bad-el-Kazar | 272 | Continuous Heal + Poison | ✅ **Healing** (not Trial 7 yet) |
| 5 | Geomancer | 267 | HP Burn + Weaken | Damage core |

**Speed Tune:** 3:2 (same as Clan Boss)  
**Chimera Boss SPD:** 190+ (may need +10 SPD on all champions for 4:3 tune)

**Mechanics Coverage:**
| Mechanic | Source | Uptime | Trial Value |
|----------|--------|--------|-------------|
| **Decrease ATK 50%** | Rector A1 + Stag A2 | **100%** | ✅ **Trial 5 complete** |
| Decrease DEF 60% | Stag A2 | 66.7% | Damage amp |
| HP Burn | Geomancer A3 | 95% | Main damage (75k × 3 heads) |
| Continuous Heal | Bad-el A2 | 66.7% | Sustain (not Trial 7) |
| Poison | Bad-el A1 | Low | Bonus damage |
| Weaken 25% | Geomancer A3 | 95% | Team damage +25% |

**Damage Projection (Trial 5):**
- HP Burn: 75k × 3 heads × 2 ticks × 95% × 50 turns = **21.4M**
- Warmaster: 5 champs × 60% × 75k × 3 attacks × 50 = **6.75M**
- Poison: Bad-el + Geo random = **+3-5M**
- **Total: 30-35M** (enough for Trial 5 completion, not speedrun)

---

### 6.4 Trial 7 Team (Continuous Heal Focus)

**Trial 7 Requirement:** Continuous Heal 100% uptime

**Roster:** Aniri / Brogni / Bad-el-Kazar / Jareg / Geomancer

| Position | Champion | SPD | Role | Trial 7 Contribution |
|----------|----------|-----|------|---------------------|
| 1 | Godseeker Aniri | 277 | Buff Extension | Extends Continuous Heal |
| 2 | Underpriest Brogni | 274 | Block Debuffs | Survivability |
| 3 | **Bad-el-Kazar** | 272 | Continuous Heal (A2) | ✅ 2× stacks (66.7% uptime) |
| 4 | **Jareg** | 267 | Continuous Heal (A2) + Ally Protect | ✅ **100% uptime** (staggered with Bad-el) |
| 5 | Geomancer | 267 | HP Burn + Weaken | Damage |

**Continuous Heal Rotation:**
- Turn 1: Bad-el A2 (2 stacks, 3-turn CD)
- Turn 2: Jareg A2 (2 stacks, 4-turn CD)
- Turn 4: Aniri A2 (extend Bad-el Continuous Heal +1 turn)
- Turn 5: Bad-el A2 refresh
- **Uptime:** 100% (staggered CDs + Aniri extension)

**Healing Math:**
- Bad-el Continuous Heal: 2 stacks × 7.5% = 15% MAX HP/turn
- Jareg Continuous Heal: 2 stacks × 7.5% = 15% MAX HP/turn
- Total: **30% MAX HP/turn** = 15k-30k HP/turn per champion
- **Total team healing:** 75k-150k HP/turn

**Damage Projection (Trial 7):**
- HP Burn: 75k × 3 heads × 2 ticks × 95% × 60 turns = **25.7M**
- Warmaster: 5 champs × 60% × 75k × 3 attacks × 60 = **8.1M**
- **Total: 33-40M** (safe clear, slower than Trial 5)

---

### 6.5 Chimera Head Priority

**Head Kill Order (Universal Strategy):**
1. **Right Head First** (Decrease ACC, Weaken, HP Burn)
2. **Left Head Second** (Decrease SPD, Decrease C.DMG)
3. **Body Last** (main HP pool)

**Why This Order:**
- Right head = reduces team accuracy (kills Dec DEF/ATK landing)
- Left head = reduces speed (less dangerous than accuracy loss)
- Body = no dangerous mechanics until heads dead

**Targeting Strategy:**
- Manual: Focus fire right head → left → body
- Auto: ❌ **DO NOT USE** (will spread damage randomly)

---

### 6.6 Chimera Quick Reference

| Trial | Achievable? | Team | Expected Damage | Time Investment |
|-------|-------------|------|-----------------|-----------------|
| **Trial 4** | ❌ NO | Missing Dec SPD champions | N/A | Need new champions |
| **Trial 5** | ✅ YES | Rector/Brogni/Stag/Bad-el/Geo | 30-35M | ✅ Ready now |
| **Trial 6** | ❌ NO | Missing Inc DEF champions | N/A | Need new champions |
| **Trial 7** | ✅ YES | Aniri/Brogni/Bad-el/Jareg/Geo | 33-40M | ⚠️ Jareg needs build |

**Recommendations:**
1. ✅ **Start with Trial 5** (Rector team ready)
2. ⏸️ **Build Jareg for Trial 7** (2-3 weeks)
3. ❌ **Skip Trial 4 & 6** until pulling Dec SPD / Inc DEF champions
...
- [Chimera Boss Guide - Comprehensive Strategy Guide (FINAL)](#chimera-boss-guide---comprehensive-strategy-guide-final)
  - [Document History \& Enhancement Overview](#document-history--enhancement-overview)
    - [File Evolution](#file-evolution)
    - [Enhancement Scope Applied](#enhancement-scope-applied)
    - [Enhancement Pattern Summary](#enhancement-pattern-summary)
    - [Quality Standards Met ✅](#quality-standards-met-)
    - [Team Enhancement Status](#team-enhancement-status)
  ...
  - [3. Chimera Trials: Combo Table (Champions Who Can Fulfill Multiple Trials)](#3-chimera-trials-combo-table-champions-who-can-fulfill-multiple-trials)
  - [4. Quick Reference Tables](#4-quick-reference-tables)
    - [A. Best Teams by Difficulty \& Trial Focus](#a-best-teams-by-difficulty--trial-focus)
    - [B. Quick Reference: Key Champions by Role](#b-quick-reference-key-champions-by-role)
    - [C. Trial Priority \& Easy Wins](#c-trial-priority--easy-wins)
  - [5. Teams by Estimated Damage/Trial Completion](#5-teams-by-estimated-damagetrial-completion)
  - [6. Optimal Team Callout: Chimera Boss (Owned Champions)](#6-optimal-team-callout-chimera-boss-owned-champions)
  - [7. Detailed Team Recommendations](#7-detailed-team-recommendations)
    ...
    - [Team 4: Trials Maximizer (All-Trial Focus)](#team-4-trials-maximizer-all-trial-focus)
      - [Speed Tuning \& Turn Order](#speed-tuning--turn-order)
      - [Affinity Safety/Risk](#affinity-safetyrisk)
      - [Detailed Trial Advice \& Priority](#detailed-trial-advice--priority)
    - [Team 5: 65-Turn Damage Engine (Massive Damage, Ignores Trials)](#team-5-65-turn-damage-engine-massive-damage-ignores-trials)
      - [Speed Tuning \& Turn Order](#speed-tuning--turn-order-1)
      - [Manual/Auto Compromise](#manualauto-compromise)
      - [Affinity Safety/Risk](#affinity-safetyrisk-1)
      - [Damage-Focused Turn-by-Turn Guide](#damage-focused-turn-by-turn-guide)
    - [Team 6: Balanced Damage \& Trials (Hybrid)](#team-6-balanced-damage--trials-hybrid)
      - [Speed Tuning \& Turn Order](#speed-tuning--turn-order-2)
      - [Manual/Auto Compromise](#manualauto-compromise-1)
      - [Affinity Safety/Risk](#affinity-safetyrisk-2)
  - [8. Champion Participation by Team (Quick Reference)](#8-champion-participation-by-team-quick-reference)
  - [9. Notes](#9-notes)
  - [10. Ideal Champions to Pull (Amplify/Enable Teams)](#10-ideal-champions-to-pull-amplifyenable-teams)
    - [S-Tier (Enable New Archetypes or Maximize Trials)](#s-tier-enable-new-archetypes-or-maximize-trials)
    - [A-Tier (Amplify Existing Teams or Fill Gaps)](#a-tier-amplify-existing-teams-or-fill-gaps)
    - [B-Tier (Specialized or Niche Upgrades)](#b-tier-specialized-or-niche-upgrades)
  - [11. Team Upgrade Paths (How Each Pull Would Help)](#11-team-upgrade-paths-how-each-pull-would-help)
