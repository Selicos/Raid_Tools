...
champions_dir: str = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "data", "champions"))
summary_dir: str = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "output", "ChampionSummary"))
cooldown_analysis_dir: str = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "output", "cooldown_analysis"))
