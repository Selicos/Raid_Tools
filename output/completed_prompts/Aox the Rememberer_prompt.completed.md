# Champion Log Generation Prompt for Aox the Rememberer

You are to generate a complete champion log for Aox the Rememberer in JSON format, using the following module templates as structure and guidance. Each module (0–13) is included below. For each, fill in the relevant information for Aox the Rememberer. Output a single JSON object with each module as a key (e.g., "overview", "skills", "synergy", etc.).

---
## Example output structure:
```json
{
  "champion": "Aox the Rememberer",
  "owned": true,
  "overview": { ... },
  "skills": { ... },
  "team_inputs": { ... },
...
---
Instructions:
- Fill in each section for Aox the Rememberer using the module templates below.
