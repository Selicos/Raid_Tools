...
## Key Boss Mechanics & Stat Requirements
...
- **Required Stats:**
  ...
  - HP/DEF: High for sustain/support
  - Resist: 350+ (for support/cleanser if aiming to resist poisons)
...
**Simulated Clear Time:** 1:00 (theoretical best)
...
**Core Roles:** Double Coldheart, Royal Guard (MAX HP), Shield (Brogni), Cleanse/Heal (Tagoar)

**Optimal Combo:** Brogni, Tagoar, Coldheart, Coldheart, Royal Guard

**Simulated Clear Time:** 1:05
...
### Team: Double Coldheart + Poison Hybrid
**Core Roles:** Double Coldheart, Poison/Support (Venomage or Fayne), Shield (Brogni), Cleanse/Heal (Tagoar)

**Optimal Combo:** Brogni, Tagoar, Coldheart, Coldheart, Venomage/Fayne

**Simulated Clear Time:** 1:15

**Strengths:** Fast clears, TM lock, poison backup for boss HP

**Weaknesses:** Less revive/extension, needs high accuracy

---

### Team: Coldheart TM Control
**Core Roles:** Shield (Brogni), Buff Extension/Revive (Godseeker Aniri), Enemy MAX HP Nuker (Coldheart), Cleanse/Heal (Tagoar), Poison/Support (Venomage)

**Optimal Combo:** Brogni, Godseeker Aniri, Coldheart, Tagoar, Venomage

**Simulated Clear Time:** 1:20

**Strengths:** Fast clears, strong TM control, shield and cleanse for safety

**Weaknesses:** Relies on Coldheart for burst; needs high accuracy and speed
...
### Team: Full Poison Layering
**Core Roles:** Poison (Venomage), Poison/Weaken (Fayne), Poison Exploder (Taurus), Debuff Extension (Narma the Returned), Cleanse/Heal (Tagoar)

**Optimal Combo:** Venomage, Fayne, Taurus, Narma the Returned, Tagoar

**Simulated Clear Time:** 2:00

**Strengths:** High poison uptime, can burst boss with Taurus, strong sustain and layering

**Weaknesses:** Needs high accuracy, careful poison management, and timing for Taurus explosion

---

### Team: Poison/Support Hybrid
**Core Roles:** Poison (Venomage), Poison/Weaken (Fayne), Poison Exploder (Taurus), Shield (Brogni), Buff Extension/Revive (Godseeker Aniri)

**Optimal Combo:** Venomage, Fayne, Taurus, Brogni, Godseeker Aniri

**Simulated Clear Time:** 2:10

**Strengths:** High poison burst, strong sustain, revive insurance

**Weaknesses:** Needs high accuracy, careful skill cycling, and protection for Taurus

---

## Turn Meter Control & Crowd Control Teams

### Team: Royal Guard Double Nuker
**Core Roles:** Shield (Brogni), Buff Extension (Godseeker Aniri), Enemy MAX HP (Royal Guard), TM Control (Coldheart), Cleanse/Heal (Tagoar)

**Optimal Combo:** Brogni, Godseeker Aniri, Royal Guard, Coldheart, Tagoar

**Simulated Clear Time:** 1:45

**Strengths:** Double MAX HP nukes, strong TM control, shield and cleanse

**Weaknesses:** Needs careful TM cycling, high gear/stat requirements
...
## General Team-Building Notes (Hard Spider)
...
## Ideal Champions to Pull (Expanded)
...
## Additional Team Archetypes (for future expansion)

- Spiderling Control/CC Teams: Maulie Tankard, Scyl of the Drakes, Archmage Hellmut
- Full Cleanse/Block Debuffs Teams: Mithrala, Mausoleum Mage, Tagoar
- Niche/Experimental Teams: Loki the Deceiver, Embrys, Sun Wukong
...
- Prince Kymar (reset, TM control)
- Siphi the Lost Bride (revive, cleanse)
- Lydia the Deathsiren (DEF down, Weaken)
- Skytouched Shaman (cleanse, heal)
- Others by role...
