# Copilot & AI Agent Instructions (Variant 3 - Expanded)

> Authoritative, codebase-specific guide for AI coding agents. Universal rules: `.github/ai-assistant-instructions.md`.
